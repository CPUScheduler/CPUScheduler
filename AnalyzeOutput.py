...
if __name__ == "__main__":
    ...
    for d in dirs:
        ...
        # RRRRHRRN
        re_rrrrhrrn = re.compile(".*_RR(.*)RR(.*)HRRN_cpu(.*)\.csv")
        rrrrhrrn_files = []
        for f in files:
        ...
        if len(fcfs.index):
            ...
            plt.savefig("Single FCFS Queue.png")
            ...
            plt.subplots_adjust(wspace=0.3, hspace=0.4)
            plt.savefig("Multiple FCFS Queues.png")
        ...
        if len(rrrrfcfs.index):
            ...
            if False:
                ...
                plt.subplots_adjust(wspace=0.3, hspace=0.4)
                plt.savefig("RR RR FCFS Queues for "+str(core)+" cores.png")
            ...
            plt.subplots_adjust(wspace=0.3, hspace=0.4)
            plt.savefig("RR RR FCFS Queues.png")
